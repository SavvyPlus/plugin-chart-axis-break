...
const config = {
  ...
  controlPanelSections: [{
    ...
    label: (0, _translation.t)('Hello Controls!'),
    expanded: true,
    controlSetRows: [[{
      name: 'header_text',
      config: {
        ...
        label: (0, _translation.t)('Header Text'),
        description: (0, _translation.t)('The text you want to see in the header')
      }
    }], [{
      name: 'bold_text',
      config: {
        type: 'CheckboxControl',
        label: (0, _translation.t)('Bold Text'),
        renderTrigger: true,
        default: true,
        description: (0, _translation.t)('A checkbox to make the ')
      }
    }], [{
      ...
      config: {
        ...
        renderTrigger: true,
        description: (0, _translation.t)('The size of your header font')
      }
    }]]
  }],
  controlOverrides: {
