...
const metadata = new _chart.ChartMetadata({
  description: 'Axis Break',
  name: (0, _translation.t)('AxisBreak'),
  thumbnail: _thumbnail.default
});

class AxisBreakChartPlugin extends _chart.ChartPlugin {
  /**
  ...
  constructor() {
    super({
      ...
      loadChart: () => Promise.resolve().then(() => _interopRequireWildcard(require('../AxisBreak'))),
      metadata,
...
exports.default = AxisBreakChartPlugin;