...
interface AxisBreakStylesProps {
  height: number;
  width: number;
...
const Styles = styled.div<AxisBreakStylesProps>`
...
export default function AxisBreak(props: AxisBreakProps) {
